...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdImagesBody', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.IdImagesBody();
      });

      it('should create an instance of IdImagesBody', function() {
        // TODO: update the code to test IdImagesBody
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.IdImagesBody);
      });
