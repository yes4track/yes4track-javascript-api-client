...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutTrailRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PutTrailRequest();
      });

      it('should create an instance of PutTrailRequest', function() {
        // TODO: update the code to test PutTrailRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PutTrailRequest);
      });
