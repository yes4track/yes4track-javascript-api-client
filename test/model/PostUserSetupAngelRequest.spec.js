...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostUserSetupAngelRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostUserSetupAngelRequest();
      });

      it('should create an instance of PostUserSetupAngelRequest', function() {
        // TODO: update the code to test PostUserSetupAngelRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostUserSetupAngelRequest);
      });
