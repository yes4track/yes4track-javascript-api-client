...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutTrackRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PutTrackRequest();
      });

      it('should create an instance of PutTrackRequest', function() {
        // TODO: update the code to test PutTrackRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PutTrackRequest);
      });
