...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllTrailResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllTrailResponse();
      });

      it('should create an instance of GetAllTrailResponse', function() {
        // TODO: update the code to test GetAllTrailResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllTrailResponse);
      });
