...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostExperienceResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostExperienceResponse();
      });

      it('should create an instance of PostExperienceResponse', function() {
        // TODO: update the code to test PostExperienceResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostExperienceResponse);
      });
