...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutAdventureRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PutAdventureRequest();
      });

      it('should create an instance of PutAdventureRequest', function() {
        // TODO: update the code to test PutAdventureRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PutAdventureRequest);
      });
