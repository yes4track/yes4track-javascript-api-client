...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostAdventureLikesResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostAdventureLikesResponse();
      });

      it('should create an instance of PostAdventureLikesResponse', function() {
        // TODO: update the code to test PostAdventureLikesResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostAdventureLikesResponse);
      });
