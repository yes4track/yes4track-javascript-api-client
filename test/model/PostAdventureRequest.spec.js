...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostAdventureRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostAdventureRequest();
      });

      it('should create an instance of PostAdventureRequest', function() {
        // TODO: update the code to test PostAdventureRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostAdventureRequest);
      });
