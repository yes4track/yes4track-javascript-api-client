...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdImagesBody1', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.IdImagesBody1();
      });

      it('should create an instance of IdImagesBody1', function() {
        // TODO: update the code to test IdImagesBody1
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.IdImagesBody1);
      });
