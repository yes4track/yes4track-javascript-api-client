...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllUserResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllUserResponse();
      });

      it('should create an instance of GetAllUserResponse', function() {
        // TODO: update the code to test GetAllUserResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllUserResponse);
      });
      ...
      it('should have the property companies (base name: "companies")', function() {
        // TODO: update the code to test the property companies
        expect(instance).to.have.property('companies');
        // expect(instance.companies).to.be(expectedValueLiteral);
      });
