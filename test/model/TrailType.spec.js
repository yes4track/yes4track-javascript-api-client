...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrailType', function() {
      beforeEach(function() {
        instance = Caspianyes4TrackserviceApi.TrailType;
      });

      it('should create an instance of TrailType', function() {
        // TODO: update the code to test TrailType
