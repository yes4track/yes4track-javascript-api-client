...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LevelType', function() {
      beforeEach(function() {
        instance = Caspianyes4TrackserviceApi.LevelType;
      });

      it('should create an instance of LevelType', function() {
        // TODO: update the code to test LevelType
