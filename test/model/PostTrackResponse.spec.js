...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTrackResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostTrackResponse();
      });

      it('should create an instance of PostTrackResponse', function() {
        // TODO: update the code to test PostTrackResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostTrackResponse);
      });
