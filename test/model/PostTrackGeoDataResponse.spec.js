...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTrackGeoDataResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostTrackGeoDataResponse();
      });

      it('should create an instance of PostTrackGeoDataResponse', function() {
        // TODO: update the code to test PostTrackGeoDataResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostTrackGeoDataResponse);
      });
