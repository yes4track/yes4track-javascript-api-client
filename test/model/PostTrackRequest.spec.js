...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTrackRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostTrackRequest();
      });

      it('should create an instance of PostTrackRequest', function() {
        // TODO: update the code to test PostTrackRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostTrackRequest);
      });
