...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutUserLocationRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PutUserLocationRequest();
      });

      it('should create an instance of PutUserLocationRequest', function() {
        // TODO: update the code to test PutUserLocationRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PutUserLocationRequest);
      });
