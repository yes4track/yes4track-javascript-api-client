...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedAdventureLikesResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllPagedAdventureLikesResponse();
      });

      it('should create an instance of GetAllPagedAdventureLikesResponse', function() {
        // TODO: update the code to test GetAllPagedAdventureLikesResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllPagedAdventureLikesResponse);
      });
