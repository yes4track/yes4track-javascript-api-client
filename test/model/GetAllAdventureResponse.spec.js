...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllAdventureResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllAdventureResponse();
      });

      it('should create an instance of GetAllAdventureResponse', function() {
        // TODO: update the code to test GetAllAdventureResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllAdventureResponse);
      });
      ...
      it('should have the property effectiveStartDate (base name: "effectiveStartDate")', function() {
        // TODO: update the code to test the property effectiveStartDate
        expect(instance).to.have.property('effectiveStartDate');
        // expect(instance.effectiveStartDate).to.be(expectedValueLiteral);
      });

      it('should have the property effectiveEndDate (base name: "effectiveEndDate")', function() {
        // TODO: update the code to test the property effectiveEndDate
        expect(instance).to.have.property('effectiveEndDate');
        // expect(instance.effectiveEndDate).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property imagesUrl (base name: "imagesUrl")', function() {
        // TODO: update the code to test the property imagesUrl
        expect(instance).to.have.property('imagesUrl');
        // expect(instance.imagesUrl).to.be(expectedValueLiteral);
      });

      it('should have the property videosUrl (base name: "videosUrl")', function() {
        // TODO: update the code to test the property videosUrl
        expect(instance).to.have.property('videosUrl');
        // expect(instance.videosUrl).to.be(expectedValueLiteral);
      });

      it('should have the property codeRequired (base name: "codeRequired")', function() {
        // TODO: update the code to test the property codeRequired
        expect(instance).to.have.property('codeRequired');
        // expect(instance.codeRequired).to.be(expectedValueLiteral);
      });
