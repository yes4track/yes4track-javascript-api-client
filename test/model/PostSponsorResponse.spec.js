...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostSponsorResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostSponsorResponse();
      });

      it('should create an instance of PostSponsorResponse', function() {
        // TODO: update the code to test PostSponsorResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostSponsorResponse);
      });
