...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserTrailStatusResponse', function() {
      beforeEach(function() {
        instance = Caspianyes4TrackserviceApi.UserTrailStatusResponse;
      });

      it('should create an instance of UserTrailStatusResponse', function() {
        // TODO: update the code to test UserTrailStatusResponse
