...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedSponsorResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllPagedSponsorResponse();
      });

      it('should create an instance of GetAllPagedSponsorResponse', function() {
        // TODO: update the code to test GetAllPagedSponsorResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllPagedSponsorResponse);
      });
