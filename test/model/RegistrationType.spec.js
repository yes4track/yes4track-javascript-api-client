...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegistrationType', function() {
      beforeEach(function() {
        instance = Caspianyes4TrackserviceApi.RegistrationType;
      });

      it('should create an instance of RegistrationType', function() {
        // TODO: update the code to test RegistrationType
