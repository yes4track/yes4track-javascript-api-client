...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostSponsorRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostSponsorRequest();
      });

      it('should create an instance of PostSponsorRequest', function() {
        // TODO: update the code to test PostSponsorRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostSponsorRequest);
      });
