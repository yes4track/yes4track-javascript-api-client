...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdVideosBody', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.IdVideosBody();
      });

      it('should create an instance of IdVideosBody', function() {
        // TODO: update the code to test IdVideosBody
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.IdVideosBody);
      });
