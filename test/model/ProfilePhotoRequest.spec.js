...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProfilePhotoRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.ProfilePhotoRequest();
      });

      it('should create an instance of ProfilePhotoRequest', function() {
        // TODO: update the code to test ProfilePhotoRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.ProfilePhotoRequest);
      });
