...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdventureType', function() {
      beforeEach(function() {
        instance = Caspianyes4TrackserviceApi.AdventureType;
      });

      it('should create an instance of AdventureType', function() {
        // TODO: update the code to test AdventureType
