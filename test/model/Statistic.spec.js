...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Statistic', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.Statistic();
      });

      it('should create an instance of Statistic', function() {
        // TODO: update the code to test Statistic
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.Statistic);
      });
      ...
      it('should have the property elevationLoss (base name: "elevationLoss")', function() {
        // TODO: update the code to test the property elevationLoss
        expect(instance).to.have.property('elevationLoss');
        // expect(instance.elevationLoss).to.be(expectedValueLiteral);
      });

      it('should have the property elevationMin (base name: "elevationMin")', function() {
        // TODO: update the code to test the property elevationMin
        expect(instance).to.have.property('elevationMin');
        // expect(instance.elevationMin).to.be(expectedValueLiteral);
      });

      it('should have the property elevationMax (base name: "elevationMax")', function() {
        // TODO: update the code to test the property elevationMax
        expect(instance).to.have.property('elevationMax');
        // expect(instance.elevationMax).to.be(expectedValueLiteral);
      });

      it('should have the property elevationMedian (base name: "elevationMedian")', function() {
        // TODO: update the code to test the property elevationMedian
        expect(instance).to.have.property('elevationMedian');
        // expect(instance.elevationMedian).to.be(expectedValueLiteral);
      });
