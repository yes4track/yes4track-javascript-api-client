...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedAdventureResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllPagedAdventureResponse();
      });

      it('should create an instance of GetAllPagedAdventureResponse', function() {
        // TODO: update the code to test GetAllPagedAdventureResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllPagedAdventureResponse);
      });
