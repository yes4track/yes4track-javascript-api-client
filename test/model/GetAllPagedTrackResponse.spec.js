...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedTrackResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllPagedTrackResponse();
      });

      it('should create an instance of GetAllPagedTrackResponse', function() {
        // TODO: update the code to test GetAllPagedTrackResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllPagedTrackResponse);
      });
