...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedNotificationResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.GetAllPagedNotificationResponse();
      });
      ...
      it('should create an instance of GetAllPagedNotificationResponse', function() {
        ...
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.GetAllPagedNotificationResponse);
      });
