...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostAdventureResponse', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostAdventureResponse();
      });

      it('should create an instance of PostAdventureResponse', function() {
        // TODO: update the code to test PostAdventureResponse
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostAdventureResponse);
      });
