...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTrailRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostTrailRequest();
      });

      it('should create an instance of PostTrailRequest', function() {
        // TODO: update the code to test PostTrailRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostTrailRequest);
      });
