...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PhotosUploadBody', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PhotosUploadBody();
      });

      it('should create an instance of PhotosUploadBody', function() {
        // TODO: update the code to test PhotosUploadBody
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PhotosUploadBody);
      });
