...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutExperienceRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PutExperienceRequest();
      });

      it('should create an instance of PutExperienceRequest', function() {
        // TODO: update the code to test PutExperienceRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PutExperienceRequest);
      });
