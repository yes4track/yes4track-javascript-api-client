...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostExperienceRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostExperienceRequest();
      });

      it('should create an instance of PostExperienceRequest', function() {
        // TODO: update the code to test PostExperienceRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostExperienceRequest);
      });
