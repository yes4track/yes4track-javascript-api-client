...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrailGeoDataRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.TrailGeoDataRequest();
      });

      it('should create an instance of TrailGeoDataRequest', function() {
        // TODO: update the code to test TrailGeoDataRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.TrailGeoDataRequest);
      });
