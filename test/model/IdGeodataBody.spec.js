...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdGeodataBody', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.IdGeodataBody();
      });

      it('should create an instance of IdGeodataBody', function() {
        // TODO: update the code to test IdGeodataBody
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.IdGeodataBody);
      });
