...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTrailChunckGeoDataRequest', function() {
      beforeEach(function() {
        instance = new Caspianyes4TrackserviceApi.PostTrailChunckGeoDataRequest();
      });

      it('should create an instance of PostTrailChunckGeoDataRequest', function() {
        // TODO: update the code to test PostTrailChunckGeoDataRequest
        expect(instance).to.be.a(Caspianyes4TrackserviceApi.PostTrailChunckGeoDataRequest);
      });
